# Getting help with catmaid

Thanks for using catmaid. We're sorry if you're having trouble, but don't worry,
...
* Search GitHub for [_issues_ with the catmaid package](https://github.com/natverse/catmaid/issues).
...
* If you need to report a *new* bug:
  please [file an issue](https://github.com/natverse/catmaid/issues/new).
* If you're not sure:
